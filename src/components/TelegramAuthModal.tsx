            ...
            <>
              ...
              {authMethod === 'widget' && (
                <div className="text-center">
                  ...
                  <div className="mt-5 p-3 rounded-xl bg-[#0088cc]/10 border border-[#0088cc]/20 text-[11px] text-white/70 text-left flex items-start gap-2.5">
